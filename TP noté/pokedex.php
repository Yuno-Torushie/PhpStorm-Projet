	...
	<div class="pokedex">
		...
		if(isset($_POST['tri']))
		{
			try
			{
                ...
                if($_POST['condition'] != "EMPTY"
                    && $_POST['operator'] != "EMPTY"
                    && $_POST['MinMaxValue'] > 0
                    && $_POST['MinMaxValue'] < 300 )
                {
                    $sql .= " AND ". $_POST['condition']. $_POST['operator']. $_POST['MinMaxValue'];
                    array_push($arguments,$_POST['condition'], $_POST['operator'], $_POST['MinMaxValue']);
                }
